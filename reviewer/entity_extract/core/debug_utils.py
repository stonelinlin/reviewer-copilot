...
_LOG = logging.getLogger("entity_extract.debug")

# Add NullHandler to prevent "No handler found" warnings
_langextract_logger = logging.getLogger("entity_extract")
...
def configure_debug_logging() -> None:
  """Enable debug logging for the 'entity_extract' namespace only."""
  logger = logging.getLogger("entity_extract")
