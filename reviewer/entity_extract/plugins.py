...
_BUILTINS: dict[str, str] = {
    "gemini": "entity_extract.providers.gemini:GeminiLanguageModel",
    "ollama": "entity_extract.providers.ollama:OllamaLanguageModel",
}

# Optional built-in providers (require extra dependencies)
_OPTIONAL_BUILTINS: dict[str, str] = {
    "openai": "entity_extract.providers.openai:OpenAILanguageModel",
}
...
def _discovered() -> dict[str, str]:
  ...
  for ep in _safe_entry_points("entity_extract.providers"):
