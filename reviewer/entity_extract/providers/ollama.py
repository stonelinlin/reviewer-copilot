...
Usage with extract():
    import entity_extract as lx
    from entity_extract.data import ExampleData, Extraction
...
Direct provider instantiation (when model ID conflicts with other providers):
    from entity_extract.providers.ollama import OllamaLanguageModel
...
Using pre-configured FormatHandler for manual control:
    from entity_extract.providers.ollama import OLLAMA_FORMAT_HANDLER
