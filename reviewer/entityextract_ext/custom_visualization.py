...
from reviewer.entity_extract import data as _data
from reviewer.entity_extract import io as _io
from reviewer.entity_extract import visualization as _viz
...
def load_template_from_file(template_path: Union[str, pathlib.Path]) -> HTMLTemplate:
    ...
    Example:
        # In my_template.py:
        from entityextract_ext.custom_visualization import HTMLTemplate
