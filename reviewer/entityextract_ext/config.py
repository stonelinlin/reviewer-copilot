...
class LangExtractConfig:
    ...
    2. Configuration file (.entity_extract.yaml or entity_extract.json)
    ...
    def from_file(cls, path: Optional[str] = None) -> 'LangExtractConfig':
        ...
        Args:
            path: Path to config file. If None, searches for:
                  1. .entity_extract.yaml in current directory
                  2. .entity_extract.json in current directory
                  3. ~/entity_extract/config.yaml
                  4. ~/entity_extract/config.json
        ...
        if path is None:
            search_paths = [
                ...
                'entity_extract.yaml',
                'entity_extract.json',
                os.path.expanduser('~/.entity_extract/config.yaml'),
                os.path.expanduser('~/.entity_extract/config.json'),
            ]
        else:
            search_paths = [path]
